                ...
                <div class="items-center max-w-screen-sm mx-auto mb-3 space-y-4 sm:flex sm:space-y-0">
                    <div class="relative w-full">
                        ...
                        <input
                            ...
                            placeholder="Masukkan Nama Artikel" type="search" id="search" name="search"
                            autocomplete="off">
                    </div>
                    <div>
                        <button type="submit"
        ...
        <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            @empty
                <div>
                    ...
                    <a href="/posts" class="block text-blue-600 hover:underline">&laquo; Silahkan kembali ke Halaman
                        Artikel</a>
                </div>
            @endforelse
        </div>
